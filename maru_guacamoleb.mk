...
$(call inherit-product, device/oneplus/guacamole/lineage_guacamole.mk)
...
PRODUCT_NAME := maru_guacamole
PRODUCT_MODEL := Maru on the OnePlus 7 Pro
MARU_VERSION := 0.8-test
MARU_BUILD_VERSION := $(MARU_VERSION)-$(shell date -u +%Y%m%d)

DEVICE_PACKAGE_OVERLAYS += \
    device/oneplus/guacamole/overlay_maru/daydream
